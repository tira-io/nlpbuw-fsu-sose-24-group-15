...
similarities = text_train.apply(lambda x: calculate_jaccard_similarity(x['sentence1'], x['sentence2']), axis=1)
...
similarities_val = text_val.apply(lambda x: calculate_jaccard_similarity (x['sentence1'], x['sentence2']), axis=1)
